...
<div id="boardSpace">
	<div id="fix">
		...
		<div id="writeBtn">
		<a class="btn btn-default pull-right" onclick="location.href='${pageContext.request.contextPath}/board/freeBoard_write'">글쓰기</a>	
		</div>
...
<script type="text/javascript">
	...
	function boardListDisplay(pageNum) {
		...
		$.ajax({
			type: "get",
			url: "${pageContext.request.contextPath}/board/freeBoard_list?pageNum="+pageNum,
			dataType: "json",
			success: function(json) {
				...
				html+="</tr>";
				$(json.freeBoardList).each(function() {
					html+="<tr>";
