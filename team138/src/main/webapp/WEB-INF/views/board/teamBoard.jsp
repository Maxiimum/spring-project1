...
<div id="titleImages">
	<img src="${pageContext.request.contextPath}/images/board/teamBoard.png" width="1920px" height="300px">
</div>
<div id="boardSpace">
	<div id="fix">
		<div id="btn">
			<ul>
				...
				<li class="notice_select" onclick="location.href='${pageContext.request.contextPath}/board/notice'"><p>공지사항</p></li>
			</ul>
		</div>
		<div class="clear"></div>
		<div id="boardList">
		...
		<div id="writeBtn">
		<a class="btn btn-default pull-right" onclick="location.href='${pageContext.request.contextPath}/board/teamBoard_write'">글쓰기</a>	
		</div>
...
<script type="text/javascript">
	...
	function boardListDisplay(pageNum) {
		...
		$.ajax({
			type: "get",
			url: "${pageContext.request.contextPath}/board/teamBoard_list?pageNum="+pageNum,
			dataType: "json",
			success: function(json) {
				...
				html+="</tr>";
				$(json.teamBoardList).each(function() {
					html+="<tr>";
